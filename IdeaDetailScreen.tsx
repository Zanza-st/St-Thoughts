        ...
        <View style={ds.ratingBlock}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
            ...
            <View>
              ...
              <Text style={{ color: '#505050', fontSize: 11, fontFamily: 'DMSans_300Light', marginTop: 2 }}>
...
const ds = StyleSheet.create({
  ...
  backText: { fontFamily: 'DMSans_300Light', fontSize: 13, color: '#505050' },
  ...
  tagText: { fontFamily: 'DMSans_300Light', fontSize: 10, letterSpacing: 0.5 },
  ...
  handle: { fontFamily: 'DMSans_300Light', fontSize: 13, color: '#888' },
  time: { fontFamily: 'DMSans_300Light', fontSize: 10, color: '#505050', marginTop: 1 },
  body: { fontFamily: 'DMSans_300Light', fontSize: 14, color: '#888', lineHeight: 22 },
  ...
  statLabel: { fontFamily: 'DMSans_300Light', fontSize: 9, color: '#505050', letterSpacing: 1, marginTop: 2 },
  ...
  actText: { fontFamily: 'DMSans_300Light', fontSize: 13, color: '#505050' },
  shareBtn: { marginLeft: 'auto', borderWidth: 1, borderColor: '#383838' },
  sectionLabel: { fontFamily: 'DMSans_300Light', fontSize: 10, color: '#505050', letterSpacing: 2, marginBottom: 10 },
  ...
  priceType: { fontFamily: 'DMSans_300Light', fontSize: 12, color: '#505050' },
  priceGreen: { fontFamily: 'BebasNeue_400Regular', fontSize: 26, color: '#3ecf8e', letterSpacing: 1 },
  priceAmber: { fontFamily: 'DMSans_300Light', fontSize: 13, color: '#f5a623' },
  ...
  ctaBarterText: { color: '#f5a623', fontFamily: 'DMSans_300Light', fontSize: 14 },
  ...
  seekText: { fontFamily: 'DMSans_300Light', fontSize: 12, color: '#3ecf8e' },
  collabBtn: { borderWidth: 1, borderColor: 'rgba(62,207,142,.4)', borderRadius: 10, padding: 12, alignItems: 'center' },
  collabBtnText: { color: '#3ecf8e', fontFamily: 'DMSans_300Light', fontSize: 14 },
  commentsBlock: { padding: 14 },
  comment: { flexDirection: 'row', gap: 9, marginBottom: 16 },
  commentName: { fontFamily: 'DMSans_300Light', fontSize: 12, color: '#c4a882', marginBottom: 3 },
  commentBody: { fontFamily: 'DMSans_300Light', fontSize: 13, color: '#888', lineHeight: 20 },
  commentTime: { fontFamily: 'DMSans_300Light', fontSize: 10, color: '#505050', marginTop: 3 },
  commentInput: {
  ...
  commentField: {
    ...
    fontSize: 13, fontFamily: 'DMSans_300Light',
  },
  sendBtn: {
