...
const tagS = StyleSheet.create({
  ...
  text: { fontFamily: 'DMSans_300Light', fontSize: 10, letterSpacing: 0.5 },
})
...
const cs = StyleSheet.create({
  ...
  time: { fontFamily: 'DMSans_300Light', fontSize: 11, color: '#505050' },
  ...
  handle: { fontFamily: 'DMSans_300Light', fontSize: 12, color: '#888' },
  title: { fontFamily: 'PlayfairDisplay_600SemiBold', fontSize: 17, color: '#efefef', lineHeight: 24, marginBottom: 6 },
  body: { fontFamily: 'DMSans_300Light', fontSize: 13, color: '#888', lineHeight: 20, marginBottom: 10 },
  pricingRow: {
  ...
  priceAmber: { fontFamily: 'DMSans_300Light', fontSize: 12, color: '#f5a623' },
  ...
  actCount: { fontFamily: 'DMSans_300Light', fontSize: 12, color: '#505050' },
  voted: { color: '#a78bfa' },
  fired: { color: '#f5a623' },
})
...
const fs = StyleSheet.create({
  ...
  wordmarkSub: { fontFamily: 'DMSans_300Light', fontSize: 10, color: '#505050', letterSpacing: 3, marginTop: 2 },
  ...
  fpillText: { fontFamily: 'DMSans_300Light', fontSize: 13, color: '#505050' },
  ...
  composeInput: {
    ...
    padding: 14, color: '#efefef', fontSize: 15, fontFamily: 'DMSans_300Light',
  ...
  catChipText: { fontFamily: 'DMSans_300Light', fontSize: 12, color: '#505050' },
